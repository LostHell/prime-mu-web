...
export type DepositItemConfig = {
  ...
  /** group and index in the warehouse binary. Undefined for zen (not a binary item; uses warehouse.Money). */
  itemId?: ItemIconId;
};
